...
impl SwapBuilder {
    ...
    #[inline(always)]
    pub fn swap_parameters(&mut self, swap_parameters: SwapParameters) -> &mut Self {
        self.swap_parameters = Some(swap_parameters);
        self
    }
    ...
    pub fn instruction(&self) -> solana_program::instruction::Instruction {
        ...
        let args = SwapInstructionArgs {
            swap_parameters: self
                .swap_parameters
                .clone()
                .expect("swap_parameters is not set"),
        };
...
impl<'a, 'b> SwapCpiBuilder<'a, 'b> {
    ...
    #[inline(always)]
    pub fn swap_parameters(&mut self, swap_parameters: SwapParameters) -> &mut Self {
        self.instruction.swap_parameters = Some(swap_parameters);
        self
    }
    /// Add an additional account to the instruction.
    #[inline(always)]
